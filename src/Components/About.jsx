  ...
  return (
    <div className="flex flex-col md:flex-row items-center mx-auto">
      <div className="w-full md:w-2/3 text-center text-gray-900 p-10">
        ...
        <p className="font-extralight text-xs sm:text-sm md:text-7xl pt-10 leading-relaxed">
        ...
        <p className="font-extralight text-xs sm:text-sm md:text-7xl pt-36 leading-relaxed">
